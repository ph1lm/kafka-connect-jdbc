...
public class TimestampIncrementingOffsetTest {
  ...
  private final long key = 10L;
  private final TimestampIncrementingOffset unset = new TimestampIncrementingOffset(null, null, null);
  private final TimestampIncrementingOffset tsOnly = new TimestampIncrementingOffset(ts, null, null);
  private final TimestampIncrementingOffset incOnly = new TimestampIncrementingOffset(null, id, null);
  private final TimestampIncrementingOffset incAndKeyOnly = new TimestampIncrementingOffset(null, id, key);
  private final TimestampIncrementingOffset tsInc = new TimestampIncrementingOffset(ts, id, null);
  private final TimestampIncrementingOffset tsIncKey = new TimestampIncrementingOffset(ts, id, key);
  ...
  public void testEquals() {
    ...
    assertEquals(new TimestampIncrementingOffset(null, null, null), new TimestampIncrementingOffset(null, null, null));
    ...
    x = new TimestampIncrementingOffset(null, id, key);
    assertEquals(x, incAndKeyOnly);

    x = new TimestampIncrementingOffset(ts, id, key);
    assertEquals(x, tsIncKey);
  }
