...
public class JdbcSourceConnectorConfig extends AbstractConfig {
  ...
  public static final String CONNECTION_FECTH_SIZE_CONFIG = "connection.fetch.size";
  public static final String CONNECTION_FECTH_SIZE_DOC = "See java.sql.Statement.setFetchSize for details.";
  public static final String CONNECTION_FECTH_SIZE_DISPLAY = "Number of rows to fetch.";
  public static final int CONNECTION_FECTH_SIZE_DEFAULT = 0;

  public static final String CONNECTION_NETWORK_TIMEOUT_CONFIG = "connection.network.timeout";
  public static final String CONNECTION_NETWORK_TIMEOUT_DOC = "See java.sql.Connection.setNetworkTimeout for details.";
  public static final String CONNECTION_NETWORK_TIMEOUT_DISPLAY = "Network timeout";
  public static final int CONNECTION_NETWORK_TIMEOUT_DEFAULT = 60 * 1000;
  ...
  public static ConfigDef baseConfigDef() {
    return new ConfigDef()
        ...
        .define(CONNECTION_FECTH_SIZE_CONFIG, Type.INT, CONNECTION_FECTH_SIZE_DEFAULT, Importance.LOW, CONNECTION_FECTH_SIZE_DOC, DATABASE_GROUP, 6, Width.SHORT,
            CONNECTION_FECTH_SIZE_DISPLAY)
        .define(CONNECTION_NETWORK_TIMEOUT_CONFIG, Type.INT, CONNECTION_NETWORK_TIMEOUT_DEFAULT, Importance.LOW, CONNECTION_NETWORK_TIMEOUT_DOC, DATABASE_GROUP, 6, Width.SHORT, CONNECTION_NETWORK_TIMEOUT_DISPLAY)
        .define(TABLE_WHITELIST_CONFIG, Type.LIST, TABLE_WHITELIST_DEFAULT, Importance.MEDIUM, TABLE_WHITELIST_DOC, DATABASE_GROUP, 7, Width.LONG, TABLE_WHITELIST_DISPLAY,
                TABLE_RECOMMENDER)
        .define(TABLE_BLACKLIST_CONFIG, Type.LIST, TABLE_BLACKLIST_DEFAULT, Importance.MEDIUM, TABLE_BLACKLIST_DOC, DATABASE_GROUP, 8, Width.LONG, TABLE_BLACKLIST_DISPLAY,
                TABLE_RECOMMENDER)
        .define(SCHEMA_PATTERN_CONFIG, Type.STRING, null, Importance.MEDIUM, SCHEMA_PATTERN_DOC, DATABASE_GROUP, 9, Width.SHORT, SCHEMA_PATTERN_DISPLAY)
        .define(SCHEMA_NAMESPACE_PREFIX, Type.STRING, SCHEMA_NAMESPACE_PREFIX_DEFAULT, Importance.MEDIUM, SCHEMA_NAMESPACE_PREFIX_DOC, DATABASE_GROUP, 10, Width.SHORT, SCHEMA_NAMESPACE_PREFIX_DISPLAY)
        .define(NUMERIC_PRECISION_MAPPING_CONFIG, Type.BOOLEAN, NUMERIC_PRECISION_MAPPING_DEFAULT, Importance.LOW, NUMERIC_PRECISION_MAPPING_DOC, DATABASE_GROUP, 11, Width.SHORT, NUMERIC_PRECISION_MAPPING_DISPLAY)
